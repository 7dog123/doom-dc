...
ST_Responder (event_t* ev)
{
  ...
  // check for DC specific cheat selection
  if (dc_cheat_select != last_cheat_sel)
  {
    plyr->message = cheat_msg[dc_cheat_select];
    last_cheat_sel = dc_cheat_select;
  }
