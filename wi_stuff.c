...
static ipoint_t lnodes[NUMEPISODES][NUMMAPS] =
{
    // Episode 0 World Map
    {
...
void WI_drawStats(void)
{
    ...
    V_DrawPatchInDirect(SP_TIMEX, SP_TIMEY, FB, ltime);
...
void WI_loadData(void)
{
    ...
    // "time"
    ltime = W_CacheLumpName("WITIME", PU_STATIC);
